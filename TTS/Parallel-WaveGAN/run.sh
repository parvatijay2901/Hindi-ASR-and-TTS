...
n_jobs=20       # number of parallel jobs in feature extraction
...
# subset setting
shuffle=true # whether to shuffle the data to create subset
num_dev=1000   # the number of development data
num_eval=0  # the number of evaluation data
              # (if set to 0, the same dev set is used as eval set)

# training related setting
tag="hin_f_iitm"     # tag for directory to save model
