...
#    args_local = parser.parse_args()
    ...
    decoder='kenlm'
    lexicon='/home/iiit/Major_project_BJP/ASR/vakyansh_build_pretrained_model/lm/hindi_lm/lexicon.lst'
    lm_path='/home/iiit/Major_project_BJP/ASR/vakyansh_build_pretrained_model/lm/hindi_lm/lm.binary'
    for wav in glob.glob('/home/iiit/Major_project_BJP/ASR/data_eval/audio/audio_wav/*.wav'):

	    result = parse_transcription(model, dictonary, wav,  True, decoder, lexicon, lm_path, False)
	    filename=open('/home/iiit/Major_project_BJP/ASR/data_eval/results_generated/filename_text.txt','a')
	    filename.write(wav.split('/')[-1])
	    filename.write('\t')
